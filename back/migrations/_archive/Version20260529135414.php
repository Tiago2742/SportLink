 ...
 */
final class Version20260529135414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE username email VARCHAR(180) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE email username VARCHAR(180) NOT NULL');
