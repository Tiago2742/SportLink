 ...
 */
final class Version20260728071252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipe_joueur (id INT AUTO_INCREMENT NOT NULL, role VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, origine VARCHAR(255) NOT NULL, utilisateur_id INT NOT NULL, equipe_id INT NOT NULL, INDEX IDX_F046CF6DFB88E14F (utilisateur_id), INDEX IDX_F046CF6D6D861B89 (equipe_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, date_match DATETIME NOT NULL, lieu VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, statut VARCHAR(255) NOT NULL, sport_id INT NOT NULL, niveau_requis_id INT DEFAULT NULL, createur_id INT NOT NULL, INDEX IDX_232B318CAC78BCF8 (sport_id), INDEX IDX_232B318C97DEF455 (niveau_requis_id), INDEX IDX_232B318C73A201E5 (createur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, localisation VARCHAR(255) DEFAULT NULL, logo VARCHAR(512) DEFAULT NULL, date_inscription DATETIME NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
